...
export type ManagementEvidence = { id: string; kind: "MEAL_PHOTO" | "FOOD_SAMPLE"; note: string | null; uploadedAt: string; uploadedBy: string; publicUrl: string | null; demoBot?: boolean };
