...
export const demoDestination = (key: string, mode?: "single" | "full") => mode === "full" ? "/bao-suat" : ({ nurse: "/bao-suat", dietitian: "/thuc-don", kitchen: "/bep", sonde: "/bep", admin: "/quan-ly" })[key] ?? "/bao-suat";
