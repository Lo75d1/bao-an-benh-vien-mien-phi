  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="bottom" align="end" className="w-64">
        ...
        {!user.demoSessionId ? <><DropdownMenuSeparator />
          <DropdownMenuItem asChild><Link href="/ho-so"><UserRound className="size-4" />Hồ sơ của tôi</Link></DropdownMenuItem>
          <DropdownMenuItem asChild><Link href="/ho-so"><KeyRound className="size-4" />Đổi mật khẩu</Link></DropdownMenuItem></> : null}
        <DropdownMenuSeparator />
        <DropdownMenuItem
          disabled={leaving}
          onSelect={logout}
...
export function AppShell({
  ...
  return (
    <div className="app-frame">
      ...
      {user.demoWorkspace ? (
        <DemoWorkspaceSwitcher active={user.demoWorkspace} />
      ) : null}
      <header
        className="top-shell"
        style={{
      ...
      >
        ...
        <div className="top-shell-actions">
          {activeDemoClock ? (
            <span className="demo-system-label">DEMO</span>
          ) : null}
          {activeDemoClock ? (
            <a
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  ...
                  aria-label={`${adminNotifications.length} thông báo vận hành`}
                >
