...
export function AppShell({ user, children, workflowStatus, adminNotifications = [] }: { user: SessionUser; children: ReactNode; workflowStatus?: ReactNode; adminNotifications?: Array<{ id: string; label: string; detail: string }>; demoClock?: { nowIso: string; simulated: boolean } }) {
