...
export function AuditTable({ data }: { data: AuditRow[] }) { return <DataTable columns={columns} data={data} getRowId={(row) => row.id} filterPlaceholder="Lọc người, thao tác, đối tượng…" emptyMessage="Chưa có nhật ký thao tác." pageSize={10} />; }
