...
export default async function AuditPage() {
  ...
  return <AppShell user={user}><main className="workspace audit-page">
    <header className="page-heading"><div><p className="eyebrow">Quản trị</p><h1>Nhật ký thao tác</h1></div><p className="scope-note">100 thay đổi gần nhất · toàn viện</p></header>
