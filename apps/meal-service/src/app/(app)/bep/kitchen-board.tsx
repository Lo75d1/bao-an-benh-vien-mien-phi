...
type Meal = { id: string; code: string; name: string; planned: number | null; additions: number | null; total: number | null; items: MenuItem[]; status: string };
type Shopping = { foodId: string; foodName: string; edible: string; waste: string; raw: string };

export function KitchenBoard({ eventId, mealName, meals, shopping, tools }: { eventId: string; mealName: string; meals: Meal[]; shopping: Shopping[]; tools: ReactNode }) {
