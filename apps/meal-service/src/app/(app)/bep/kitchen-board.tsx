...
export function KitchenBoard({ eventId, mealName, meals, shopping, tools, canOperate }: { eventId: string; mealName: string; meals: Meal[]; shopping: Shopping[]; tools: ReactNode; canOperate: boolean }) {
