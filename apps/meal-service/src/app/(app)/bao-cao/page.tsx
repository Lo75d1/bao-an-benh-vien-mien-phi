...
export default async function ReportsPage() {
  ...
  return <AppShell user={user}><main className="workspace report-page">
    <header className="page-heading"><div><p className="eyebrow">Báo cáo</p><h1>Một trình xuất thống nhất</h1></div><p className="scope-note">{user.role === "NURSE" ? "Dữ liệu tự giới hạn theo khoa được phân công" : "Phạm vi toàn viện"}</p></header>
    <section className="report-builder" aria-labelledby="report-builder-title">
      <div className="report-builder-copy"><span>01</span><div><h2 id="report-builder-title">Chọn một lần, nhận đúng nội dung</h2><p>Dữ liệu được đọc trực tiếp từ hệ thống tại thời điểm xuất. Ô thiếu hiển thị “—”, không suy đoán.</p></div></div>
