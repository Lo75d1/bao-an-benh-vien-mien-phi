...
function mealState(data: ManagementDay, meal: ManagementMeal, now: Date) {
  return displayMealState(new Date(`${data.date}T00:00:00.000Z`), meal.cutoffTime, meal.serviceTime, statusOf(meal.diets.map((diet) => ({ diet }))), now);
}
