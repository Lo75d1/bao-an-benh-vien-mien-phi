...
const TEXT = {
  vi: {
    ...
    pendingNotesDesc: "Chỉ ghi chú được xác nhận mới chuyển sang góc ghi chú của bếp.",
    ...
    noteAction: "Cần xác nhận trước khi chuyển tới bếp",
    reportingVoice: "Đã đến thời gian báo suất ăn. Vui lòng kiểm tra và gửi báo suất.",
    handoffVoice: "Bếp đã bàn giao suất ăn. Vui lòng kiểm tra và xác nhận số lượng.",
    sondeRoute: "Qua sonde",
    oralRoute: "Đường miệng",
  },
  en: {
    ...
    pendingNotesDesc: "Only confirmed notes are forwarded to the kitchen notes area.",
    ...
    noteAction: "Confirmation is required before forwarding to the kitchen",
    reportingVoice: "It is time to report meal counts. Please review and submit the report.",
    handoffVoice: "The kitchen has handed off the meals. Please check and confirm the quantity.",
