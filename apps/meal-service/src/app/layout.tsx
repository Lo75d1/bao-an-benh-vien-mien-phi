...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang={locale}><body style={theme}><BrandingProvider value={branding}><DemoClockProvider value={clock.enabled ? { nowIso: clock.now.toISOString(), simulated: clock.simulated } : null}>{children}</DemoClockProvider></BrandingProvider></body></html>;
}
